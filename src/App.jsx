export default function GermanEditorialHomepage() {
  ...
  const notes = [
    '道法 / Serious Design / Ernsthaftigkeit',
    '佛缘 / Monochrome / Schwarzweiss',
    '儒事 / Grid System / Rastersystem',
    '阴阳 / Personal Archive / Archiv',
  ];
        ...
        <div className="mx-auto max-w-7xl px-6 py-5 md:px-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm font-semibold uppercase tracking-[0.15em]">
              <a href="#about" className="border-b border-transparent pb-1 hover:border-neutral-900">
                关于 / About / Über
              </a>
              <a href="#study" className="border-b border-transparent pb-1 hover:border-neutral-900">
                学习 / Study / Studium
              </a>
              <a href="#life" className="border-b border-transparent pb-1 hover:border-neutral-900">
                生活 / Life / Leben
              </a>
              <a href="#contact" className="border-b border-transparent pb-1 hover:border-neutral-900">
                联系 / Contact / Kontakt
              </a>
            </nav>
          </div>
...
Darum habe ich diese Seite geschaffen, um mein Denken, mein Lernen und meine Vorlieben zu bewahren; klein zwar, doch mein eigener stiller Ort.`}
        ...
        <section id="contact" className="grid gap-8 py-10 md:grid-cols-12 md:py-16">
          ...
          <div className="md:col-span-9 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <div className="text-3xl font-black uppercase md:text-5xl">
                君子有九思 / Reflection and Dwelling / Denken und Verweilen
              </div>
